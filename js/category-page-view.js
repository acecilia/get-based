...
export function showCategory(categoryKey, preData) {
  ...
  const renameBtn = isVirtualCategory(categoryKey) ? '' : ` <span class="ref-edited-badge" role="button" tabindex="0" aria-label="Rename category" title="Rename category" onclick="event.stopPropagation();renameCategory('${categoryKey}')" style="cursor:pointer;font-size:12px">rename</span>`;
